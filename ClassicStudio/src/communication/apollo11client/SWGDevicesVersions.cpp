...
SWGDevicesVersions::fromJsonObject(QJsonObject pJson) {
    ...
    ::Swagger::setValue(&mac, pJson["mac"], "QString", "QString");
...
QString*
SWGDevicesVersions::getMac() {
    return mac;
}
void
SWGDevicesVersions::setMac(QString* mac) {
    this->mac = mac;
...
SWGDevicesVersions::isSet(){
    ...
    do{
        ...
        if(mac != nullptr && *mac != QString("")){ isObjectUpdated = true; break;}
    }while(false);
