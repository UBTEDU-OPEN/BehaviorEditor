...
QString SWGHttpRequestWorker::http_attribute_encode_for_file(QString attribute_name, QString input)
{
    return  QString("%1=\"%2\"; %1*=utf-8''%3").arg(attribute_name, input, input.toUtf8());
}
...
void SWGHttpRequestWorker::execute(SWGHttpRequestInput *input) {
    ...
    if (input->files.length() > 0) {
        ...
        isFormData = true; //added 2020-12-17
    }
    ...
    if (input->var_layout == ADDRESS || input->var_layout == URL_ENCODED) {
        ...
        for (QList<SWGHttpRequestInputFileElement>::iterator file_info = input->files.begin(); file_info != input->files.end(); file_info++) {
            ...
            request_content.append(QString("Content-Disposition: form-data; %1; %2").arg(
                ...
                http_attribute_encode_for_file("filename", file_info->request_filename)
            ));
            request_content.append(new_line);
    ...
    // prepare connection
//    qDebug() << "request_content=====" << request_content;
