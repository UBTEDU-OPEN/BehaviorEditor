...
/*
 * SWGVoiceGetOfflineSyntaxResponse.h
 *
 * 
 */

#ifndef SWGVoiceGetOfflineSyntaxResponse_H_
#define SWGVoiceGetOfflineSyntaxResponse_H_
...
class SWGVoiceGetOfflineSyntaxResponse: public SWGObject {
public:
    SWGVoiceGetOfflineSyntaxResponse();
    SWGVoiceGetOfflineSyntaxResponse(QString json);
    ~SWGVoiceGetOfflineSyntaxResponse();
    void init();
    void cleanup();
    ...
    SWGVoiceGetOfflineSyntaxResponse* fromJson(QString jsonString) override;
...
#endif /* SWGVoiceGetOfflineSyntaxResponse_H_ */
