              ...
              FbxAMatrix& pGlobalPosition, FbxPose* pPose, ShadingMode pShadingMode)
{
    ...
    if (lMeshCache)
    {
        ...
        for (int lIndex = 0; lIndex < lSubMeshCount; ++lIndex)
        {
            ...
            } else if ( pShadingMode == SHADING_MODE_DEFAULTCOLOR ) {
                // Draw green for faces without material shenbin 2020-04-14

                MaterialCache::SetDefaultMaterial();
            } else if ( pShadingMode == SHADING_MODE_HOVERCOLOR ) {
                // Draw red for faces without material shenbin 2020-04-22
                MaterialCache::SetHoverMaterial();
            }
