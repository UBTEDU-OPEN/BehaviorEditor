...
const GLfloat GREEN_COLOR[] = {0.0f, 0.647f, 1.0f, 1.0f};  //67  100 150/255
const GLfloat RED_COLOR[]   = {1.0f, 0.0f, 0.0f, 1.0f};  // shenbin 2020-04-24
const GLfloat WHITE_COLOR[] = {1.0f, 1.0f, 1.0f, 1.0f};
const GLfloat LIGHT_BLUE_COLOR[] = {1.0f, 1.0f, 0.0f, 1.0f};
...
#pragma warning( disable : 4312)
    ...
    if ( pShadingMode == SHADING_MODE_SHADED ||
         pShadingMode == SHADING_MODE_DEFAULTCOLOR
         /* ||pShadingMode == SHADING_MODE_HOVERCOLOR*/)
    {
...
void MaterialCache::SetHoverMaterial ()
{
    glMaterialfv(GL_FRONT, GL_EMISSION, BLACK_COLOR);
    glMaterialfv(GL_FRONT, GL_AMBIENT, BLACK_COLOR);
