...
DrawText::DrawText(const char* textureName) : mGlyph(NULL), mTextureName(0), mPointSize(DEFAULT_POINT_SIZE), mGap(DEFAULT_GAP)
{
...
void DrawText::Initialize(const char* textureName)
{
    FILE * lFile = NULL;
    FBXSDK_fopen(lFile, textureName, "rb");
    if (lFile == NULL)
    {
